...
Actions:  An action basically describes what is changed in the application, any data that gets to the application is through actions.

Reducers: A reducers uses the action and determines the change to the application.

Store:  The store hold all of the state tree in the application

'single source of truth': This is reffering to the fact that that you can onl;y change your application by dispatching a redux action.

- [ ] What is the difference between Application state and Component state? When would be a good time to use one over the other?

Application state is global and the compnent state is local.  So with Redux store that means any component can access the global or application state. As with Component state it can only pass state down do its children.  

- [ ] Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?

redux-thunk is a middleware that allows you to call action creators that return functions.  It allows us to name our action creators.  And it is used to dispatch regular synchronous actions inside the body of the function once the asynchronous operations have completed.



- [ ] What is your favorite state management system you've learned and this sprint? Please explain why!

I like redux because i have learned more about it's flow athat context api and it is super good at managing and passing state allaround cmpnents. 
